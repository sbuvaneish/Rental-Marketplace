...
define("database", "marketplace"); // your database 
...
class Private_messaging_system{
	...
	public function send_message($to, $message){
		...
		$query = "INSERT INTO " . TBL_MESSAGES . " (user_to, user_from, message) VALUES(" . $to . ", " . $from . ", '" . $message . "')";
		mysql_query($query);
	}
	
	public function get_messages($from, $to){
		$query = "SELECT ";
		mysql_query($query);
	}
