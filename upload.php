...
// Post method from within the page
  ...
  if(isset($_POST['btnSubmit'])) {
    ...
    $price_val = $_POST['product_price'] ? $_POST['product_price'] : 'NULL';
    ...
    if(((!$_POST['image_url'] and isset($_SESSION['product_id'])) or !$imagerr) and !$descriptionerr and !$availabilityerr) {
